...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    render() {
      ...
      const contenedor = this.querySelector(".results");
      const template = this.querySelector("#template");
      const myModal = this.querySelector(".modal")!;
      ...
      myModal.addEventListener("shown.bs.modal", (e) => {
        ...
        const inputReporterTelefono = myModal.querySelector(
          ".telefono"
        )! as any;
      ...
      state.mostrarMascotasCercaTuyo(contenedor, template);
    }
  }
);
